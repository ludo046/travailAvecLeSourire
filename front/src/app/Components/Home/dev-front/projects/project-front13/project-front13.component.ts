...
@Component({
  selector: 'app-project-front13',
  templateUrl: './project-front13.component.html',
  styleUrls: ['./project-front13.component.scss']
})
export class ProjectFront13Component implements OnInit {
