...
@Component({
  selector: 'app-project-front4',
  templateUrl: './project-front4.component.html',
  styleUrls: ['./project-front4.component.scss']
})
export class ProjectFront4Component implements OnInit {
