...
@Component({
  selector: 'app-project-front10',
  templateUrl: './project-front10.component.html',
  styleUrls: ['./project-front10.component.scss']
})
export class ProjectFront10Component implements OnInit {
