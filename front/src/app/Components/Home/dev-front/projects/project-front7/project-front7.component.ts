...
@Component({
  selector: 'app-project-front7',
  templateUrl: './project-front7.component.html',
  styleUrls: ['./project-front7.component.scss']
})
export class ProjectFront7Component implements OnInit {
