...
@Component({
  selector: 'app-project-front12',
  templateUrl: './project-front12.component.html',
  styleUrls: ['./project-front12.component.scss']
})
export class ProjectFront12Component implements OnInit {
