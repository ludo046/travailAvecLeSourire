...
@Component({
  selector: 'app-project-front8',
  templateUrl: './project-front8.component.html',
  styleUrls: ['./project-front8.component.scss']
})
export class ProjectFront8Component implements OnInit {
